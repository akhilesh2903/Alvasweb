...
import { ExternalLink, Quote, Calendar, Tag } from "lucide-react";
...
export default function ResearchCard({ item }: ResearchCardProps) {
    ...
    return (
        <motion.div
            ...
            className="group relative flex flex-col overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white p-10 shadow-sm transition-all hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]"
        >
