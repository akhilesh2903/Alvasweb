      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-start justify-between gap-6 mb-6">
          <div className="flex flex-wrap gap-2">
            <span
              className={`rounded-full px-4 py-1.5 text-[10px] font-black uppercase tracking-widest ${isStudent ? "bg-purple-100 text-purple-700" : "bg-emerald-100 text-emerald-700"}`}
            >
              {isStudent ? "Student Pioneer" : "Faculty Expert"}
            </span>
            <span
              className={`rounded-full px-4 py-1.5 text-[10px] font-black uppercase tracking-widest ${impactColor}`}
            >
              {impact} Impact
            </span>
        ...
        <div className="mt-auto flex flex-col gap-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[11px] font-black uppercase tracking-wider text-blue-500/60">
                {item.category}
              </span>
            </div>
          </div>
