    ...
    return (
        <div className="mb-14 space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                {/* Faculty Selection */}
                <div className={`flex items-center gap-2 rounded-2xl border border-slate-200 bg-white/60 px-4 py-2.5 shadow-sm backdrop-blur-xl transition-all hover:bg-white hover:border-blue-200 ${selectedDept === "All" ? "opacity-50 grayscale pointer-events-none" : ""}`}>
