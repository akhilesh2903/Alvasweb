    ...
    <div className="space-y-8 animate-pulse">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-blue-400/80">
                  Real-time Analysis
                </span>
              </div>
      ...
      <div className="rounded-[2.5rem] bg-white/80 backdrop-blur-xl border border-slate-200 p-10 h-[450px] shadow-sm">
        ...
        <div className="flex items-end justify-between h-[280px] gap-6 px-4">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="flex-1 bg-blue-50/50 rounded-2xl border border-blue-100/30"
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="rounded-[2rem] bg-white/80 backdrop-blur-xl border border-slate-100 p-8 space-y-6 shadow-sm"
          >
