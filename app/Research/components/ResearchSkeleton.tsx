...
import { Database, ShieldCheck, Zap, BarChart3, Search } from "lucide-react";
...
export default function ResearchSkeleton() {
    ...
    return (
        <div className="space-y-8 animate-pulse">
            ...
            {/* Chart Skeleton */}
            <div className="rounded-[2.5rem] bg-white border border-slate-200 p-10 h-[450px] shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {[...Array(6)].map((_, i) => (
                    <div key={i} className="rounded-[2rem] bg-white border border-slate-100 p-8 space-y-6 shadow-sm">
