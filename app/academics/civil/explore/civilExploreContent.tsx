...
import { civilDepartmentData } from "./civilData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import CivilExploreLoading from "./civilExploreLoading";
...
export default function CivilExploreContent() {
  const department = civilDepartmentData;
                            ...
                            data={[
                              {
                                ...
                                semesters: [
                                  {
                                    name: "Full Year",
                                    id: "18QRVxQRTG0sfsoKzFl3EDMr9zY6dNQ01",
                                  },
                                ],
                              },
                              {
                                ...
                                semesters: [
                                  {
                                    name: "Full Year",
                                    id: "1yXgFG3w-wsuoh6aVPbiIMtleo0rk8EPa",
                                  },
                                ],
                              },
                              {
                                ...
                                semesters: [
                                  {
                                    name: "Full Year",
                                    id: "174PjdilbgJ00jFtlIXyWesOXpBj8ab1G",
                                  },
                                ],
                              },
                              {
                                ...
                                semesters: [
                                  {
                                    name: "Full Year",
                                    id: "1Qm2aZveg2sXBvsh_4738Q7dJRpeUKbQU",
                                  },
                                ],
                              },
                              {
                                ...
                                semesters: [
                                  {
                                    name: "Full Year",
                                    id: "1Lyaa2GB06-p2Se50Z97Cmx9RgNcwsiZ1",
                                  },
                                ],
                              },
                            ]}
                            backPath="/academics/civil/explore"
