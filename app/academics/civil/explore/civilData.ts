...
M3: To promote innovation in the minds of future engineers to face the challenges.`,
  ...
  faculty: Array.from(
    ...
    (_, i): Faculty => ({
      ...
      details: {
        ...
        researchPublications: "Rcivilnt Research in Domain (2023)",
        others: "NA",
      },
    }),
  ),
  exploreData: {
    about: {
      ...
      body: `The Department of Civil Engineering prepares students for the design, construction, and maintenance of the physical and naturally built environment, prioritizing sustainability and safety.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Structural Engineering, Concrete Technology, Transportation, and Environmental Engineering.",
      highlights: [
...
PSO4: The graduates will be able to demonstrate professional integrity and an appreciation of ethical, environmental, regulatory and issues related to civil engineering projects.`,
    ...
    newsletter: {
      title: "E-NEWSLETTER",
      body: "Quarterly updates from the department of CIVIL.",
      highlights: [
