...
import { mathematicsDepartmentData } from "./mathematicsData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import MathematicsExploreLoading from "./mathematicsExploreLoading";
...
export default function MathematicsExploreContent() {
  const department = mathematicsDepartmentData;
  ...
  if (!isMounted) {
    return <MathematicsExploreLoading />;
  }
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/mathematics/explore"
