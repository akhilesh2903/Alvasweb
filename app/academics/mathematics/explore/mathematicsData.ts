...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF MATHEMATICS",
      body: `The Department of Mathematics provides the analytical framework and computational logic fundamental to all branches of engineering and technological research.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Engineering Mathematics, Calculus, Linear Algebra, and Discrete Math.",
      highlights: [
