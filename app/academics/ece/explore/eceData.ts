...
3. "Quality Issues in Digital Image Recovery from the Print-Scan Channel", IEEE International Conference (ETSEBDM), 2014.
4. "Smart Plant monitoring system: A review of approaches", IJARSCT, Vol 4, Issue 2, 2024.
5. "Farm to table automating fruit yield and sales using ESP-32 CAM", 7th ICEAT, 2025.`,
        others: "Nil",
      },
    },
    {
      ...
      details: {
        ...
        subjectsTeaching:
          "Antenna & Propagation, Engineering Electromagnetics, Fundamentals of HDL, Digital Signal Processing, Logic Design, Field Theory, Basic Electronics, DSP Algorithm & Architecture, Operating Systems, Digital Communication.",
