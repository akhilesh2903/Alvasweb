...
import { dsDepartmentData } from "./dsData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import DsExploreLoading from "./dsExploreLoading";
...
export default function DsExploreContent() {
  const department = dsDepartmentData;
