...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF IOT, CYBERSECURITY & BLOCKCHAIN",
      body: `The Department focuses on securing digital infrastructures, building interconnected smart networks, and developing decentralized ledger systems for modern critical applications.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Network Security, Internet of Things, Smart Devices, and Distributed Ledgers.",
      highlights: [
