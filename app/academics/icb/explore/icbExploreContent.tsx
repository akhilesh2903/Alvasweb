...
import { icbDepartmentData } from "./icbData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import IcbExploreLoading from "./icbExploreLoading";
...
export default function IcbExploreContent() {
  const department = icbDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/icb/explore"
                            departmentName="ICB"
                          />
                        ) : (
                          <div
