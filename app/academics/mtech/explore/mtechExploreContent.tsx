...
import { mtechDepartmentData } from "./mtechData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import MtechExploreLoading from "./mtechExploreLoading";
...
export default function MtechExploreContent() {
  const department = mtechDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/mtech/explore"
                            departmentName="MTECH"
                          />
                        ) : (
                          <div
