...
export const mtechDepartmentData: DepartmentData = {
  id: "mtech",
  name: "Department of Mtech",
  title: "Department of Mtech Engineering",
  vision: `Centre of excellence to empower the young minds in the field of Department of Mtech Engineering with research focus and skill development through transformative education catering to the needs of the society`,
  mission:
    `M1:	To create Learning Environment to enable the students for excellence in the field of Department of Mtech Engineering.
M2:	To empower the students with nmtechssary skills for solving the complex technological problems.
...
`,
  hod: {
    name: "Dr. MTECH HOD",
    designation: "Professor & HOD - MTECH",
    qualification: "Ph.D",
    experience: "15+ Years",
  ...
  faculty: Array.from(
    ...
    (_, i): Faculty => ({
      ...
      details: {
        qualifications: `BE in MTECH, M.Tech in Specialization`,
        ...
        researchPublications: "Rmtechnt Research in Domain (2023)",
        others: "NA",
      },
    }),
  ),
...
PO10:	Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective reports and design documentation, make effective presentations and give and rmtechive clear instructions.

PO11:	Project management and finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one’s own work, as a member and leader in a team, to manage projects and in multidisciplinary environments.

PO12:	Life-long learning: Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change.

PEO1:	Apply mathematical, scientific and engineering skills for solving problems in the area of Department of Mtech Engineering.
PEO2: Expose to emerging technologies and excel in industries/higher studies/research.
PEO3:	Apply analytical skills in the area of Department of Mtech Engineering to become competent and employable.
...
PSO1: Understand and apply the principles of Department of Mtech Engineering in various domains of Analog and Digital systems.
...
PSO3: Apply modern Hardware and software tools to analyze and solve engineering Problems.`,
    ...
    newsletter: {
      title: "E-NEWSLETTER",
      body: "Quarterly updates from the department of MTECH.",
      highlights: [
