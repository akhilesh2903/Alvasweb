...
`,
  ...
  exploreData: {
    about: {
      ...
      body: `The Department of Agriculture Engineering blends engineering principles with agricultural practices to improve farming efficiency, sustainability, and technological integration in the agribusiness sector.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Precision Farming, Farm Machinery, Soil and Water Conservation, and Food Processing.",
      highlights: [
