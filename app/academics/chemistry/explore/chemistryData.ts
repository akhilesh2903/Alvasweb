...
`,
  ...
  faculty: Array.from(
    ...
    (_, i): Faculty => ({
      ...
      email: `faculty${i + 1}.chemistry@alvas.edu.in`,
      ...
      details: {
        qualifications: `BE in CHEMISTRY, M.Tech in Specialization`,
        ...
        researchPublications: "Rchemistrynt Research in Domain (2023)",
        others: "NA",
      },
    }),
  ),
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF CHEMISTRY",
      body: `The Department of Chemistry imparts fundamental and applied chemical knowledge critical for materials engineering, environmental science, and industrial applications.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Polymer Science, Nanomaterials, Environmental Chemistry, and Green Chemistry.",
      highlights: [
...
PO10:	Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective reports and design documentation, make effective presentations and give and rchemistryive clear instructions.

PO11:	Project management and finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one’s own work, as a member and leader in a team, to manage projects and in multidisciplinary environments.

PO12:	Life-long learning: Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change.

PEO1:	Apply mathematical, scientific and engineering skills for solving problems in the area of Department of Chemistry Engineering.
PEO2: Expose to emerging technologies and excel in industries/higher studies/research.
PEO3:	Apply analytical skills in the area of Department of Chemistry Engineering to become competent and employable.
...
PSO1: Understand and apply the principles of Department of Chemistry Engineering in various domains of Analog and Digital systems.
...
PSO3: Apply modern Hardware and software tools to analyze and solve engineering Problems.`,
    ...
    newsletter: {
      title: "E-NEWSLETTER",
      body: "Quarterly updates from the department of CHEMISTRY.",
      highlights: [
