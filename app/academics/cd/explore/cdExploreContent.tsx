...
import { cdDepartmentData } from "./cdData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import CdExploreLoading from "./cdExploreLoading";
...
export default function CdExploreContent() {
  const department = cdDepartmentData;
