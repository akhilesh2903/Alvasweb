...
• Supervisor: Dr. Manjunath Kotari`,
      pastExperience: `• Associate Professor & Head - Dept. of CSD & AIML
...
• Seminar: International Conference on AI & Data Engineering`,
  ...
  faculty: Array.from(
    ...
    (_, i): Faculty => ({
      ...
      details: {
        ...
        researchPublications: "Rcdnt Research in Domain (2023)",
        others: "NA",
      },
    }),
  ),
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF COMPUTER SCIENCE & DESIGN",
      body: `The Department of Computer Science & Design integrates core computer science concepts with creative design, focusing on user experience, human-computer interaction, and digital media.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Human-Computer Interaction, UI/UX Design, Game Development, and Interactive Media.",
      highlights: [
...
PO10:	Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective reports and design documentation, make effective presentations and give and rcdive clear instructions.

PO11:	Project management and finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one’s own work, as a member and leader in a team, to manage projects and in multidisciplinary environments.

PO12:	Life-long learning: Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change.

PEO1:	Apply mathematical, scientific and engineering skills for solving problems in the area of Department of Cd Engineering.
PEO2: Expose to emerging technologies and excel in industries/higher studies/research.
PEO3:	Apply analytical skills in the area of Department of Cd Engineering to become competent and employable.
...
PSO1: Understand and apply the principles of Department of Cd Engineering in various domains of Analog and Digital systems.
...
PSO3: Apply modern Hardware and software tools to analyze and solve engineering Problems.`,
    ...
    newsletter: {
      title: "E-NEWSLETTER",
      body: "Quarterly updates from the department of CD.",
      highlights: [
