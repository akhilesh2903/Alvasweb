...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF BASIC SCIENCE & HUMANITIES",
      body: `The Department of Basic Science & Humanities forms the foundation of engineering education, providing students with essential knowledge in mathematics, physics, chemistry, and communication skills.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Applied Mathematics, Material Science, Industrial Chemistry, and Professional Ethics.",
      highlights: [
