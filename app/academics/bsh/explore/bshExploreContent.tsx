...
import { bshDepartmentData } from "./bshData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import BshExploreLoading from "./bshExploreLoading";
...
export default function BshExploreContent() {
  const department = bshDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/bsh/explore"
                            departmentName="BSH"
                          />
                        ) : (
                          <div
