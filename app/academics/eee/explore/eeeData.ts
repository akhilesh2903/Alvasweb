...
export const eeeDepartmentData: DepartmentData = {
  id: "eee",
  name: "Department of Eee",
  title: "Department of Eee Engineering",
  vision: `Centre of excellence to empower the young minds in the field of Department of Eee Engineering with research focus and skill development through transformative education catering to the needs of the society`,
  mission:
    `M1:	To create Learning Environment to enable the students for excellence in the field of Department of Eee Engineering.
M2:	To empower the students with neeessary skills for solving the complex technological problems.
...
`,
  ...
  faculty: Array.from(
    ...
    (_, i): Faculty => ({
      ...
      details: {
        qualifications: `BE in EEE, M.Tech in Specialization`,
        ...
        researchPublications: "Reeent Research in Domain (2023)",
        others: "NA",
      },
    }),
  ),
  exploreData: {
    about: {
      ...
      body: `The Department of Department of Eee Engineering (EEE) is accredited by the National Board of Accreditation, New Delhi (NBA) for a continuous period of nine years, from 01 July 2019 to 30 June 2028, reflecting the department’s commitment to academic excellence and quality education.
The Department of EEE is one of the most sought-after and dynamic branches of engineering, playing a vital role in the technological advancement and overall development of modern society. The department focuses on the design, development, manufacturing, and application of electronic devices, its software, and intelligent systems that drive today’s digital and connected world.
...
PO10:	Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective reports and design documentation, make effective presentations and give and reeeive clear instructions.

PO11:	Project management and finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one’s own work, as a member and leader in a team, to manage projects and in multidisciplinary environments.

PO12:	Life-long learning: Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change.

PEO1:	Apply mathematical, scientific and engineering skills for solving problems in the area of Department of Eee Engineering.
PEO2: Expose to emerging technologies and excel in industries/higher studies/research.
PEO3:	Apply analytical skills in the area of Department of Eee Engineering to become competent and employable.
...
PSO1: Understand and apply the principles of Department of Eee Engineering in various domains of Analog and Digital systems.
...
PSO3: Apply modern Hardware and software tools to analyze and solve engineering Problems.`,
    ...
    newsletter: {
      title: "E-NEWSLETTER",
      body: "Quarterly updates from the department of EEE.",
      highlights: [
