...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF ELECTRICAL & ELECTRONICS ENGINEERING",
      body: `The Department of Electrical & Electronics Engineering deals with the study and application of electricity, electronics, and electromagnetism in power grids, machinery, and renewable energy.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Power Systems, Control Systems, Renewable Energy, and Electric Vehicles.",
      highlights: [
