...
import { eeeDepartmentData } from "./eeeData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import EeeExploreLoading from "./eeeExploreLoading";
...
export default function EeeExploreContent() {
  const department = eeeDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/eee/explore"
                            departmentName="EEE"
                          />
                        ) : (
                          <div
