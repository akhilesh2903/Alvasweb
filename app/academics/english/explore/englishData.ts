...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF ENGLISH",
      body: `The Department of English emphasizes professional communication, technical writing, and soft skills essential for engineers to thrive in global corporate environments.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Technical Communication, Soft Skills Development, Literature, and Professional Ethics.",
      highlights: [
