...
import { englishDepartmentData } from "./englishData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import EnglishExploreLoading from "./englishExploreLoading";
...
export default function EnglishExploreContent() {
  const department = englishDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/english/explore"
