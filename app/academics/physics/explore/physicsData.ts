...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF PHYSICS",
      body: `The Department of Physics explores the fundamental laws of nature, focusing on applied physics, optics, and solid-state phenomena vital for engineering applications.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Applied Physics, Quantum Mechanics, Solid State Physics, and Optics.",
      highlights: [
