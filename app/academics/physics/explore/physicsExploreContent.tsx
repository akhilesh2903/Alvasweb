...
import { physicsDepartmentData } from "./physicsData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import PhysicsExploreLoading from "./physicsExploreLoading";
...
export default function PhysicsExploreContent() {
  const department = physicsDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/physics/explore"
