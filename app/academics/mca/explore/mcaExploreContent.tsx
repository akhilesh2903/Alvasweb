...
import { mcaDepartmentData } from "./mcaData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import McaExploreLoading from "./mcaExploreLoading";
...
export default function McaExploreContent() {
  const department = mcaDepartmentData;
                    ...
                    {activeTab === "facultyStaff" ? (
                      ...
                      <>
                        {activeTab === "newsletter" ? (
                          <NewsletterViewer
                            data={[]}
                            backPath="/academics/mca/explore"
                            departmentName="MCA"
                          />
                        ) : (
                          <div
