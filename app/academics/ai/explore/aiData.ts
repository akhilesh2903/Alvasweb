...
`,
  ...
  exploreData: {
    about: {
      title: "ABOUT DEPARTMENT OF ARTIFICIAL INTELLIGENCE & ML",
      body: `The Department of Artificial Intelligence focuses on equipping students with cutting-edge skills in Machine Learning, Neural Networks, and Data Engineering to solve complex real-world problems.`,
      highlights: [
    ...
    thrust: {
      title: "THRUST AREA",
      body: "Deep Learning, Natural Language Processing, Computer Vision, and Autonomous Systems.",
      highlights: [
