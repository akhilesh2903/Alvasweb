...
import { aiDepartmentData } from "./aiData";
import { Faculty } from "@/lib/departments";
import dynamic from "next/dynamic";
import AiExploreLoading from "./aiExploreLoading";
...
const newsletterData = [
  {
    ...
    semesters: [
      {
        name: "E-Newsletter",
        id: "1_bYiGskZMlGLWFdJkiD7JNcvsuHfclUx",
      },
    ],
  },
  {
    ...
    semesters: [
      {
        name: "E-Newsletter",
        id: "19-mneaX1XAIUJ6LHLsgpS9qaZ22VKK4f",
      },
    ],
  },
];
            ...
            <div className="hidden lg:block bg-white border border-gray-300 rounded-3xl p-4 sticky top-28 shadow-md backdrop-blur-xl max-h-[calc(100vh-9rem)] overflow-y-auto overscroll-contain">
              ...
              <div className="flex flex-col gap-2">
                {tabs.map((tab) => (
                  <button
                    key={tab.id}
                    className={`tab-btn w-full text-left px-4 py-3 rounded-2xl border border-gray-300 hover:bg-gray-200 transition font-bold text-gray-900 ${activeTab === tab.id
                        ? "active bg-gray-100"
                        : "bg-gray-100"
                      }`}
                  ...
                  <div className="space-y-8">
                    <div className="relative inline-block">
                      <motion.h2
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className={`font-black bg-gradient-to-r from-indigo-700 via-purple-700 to-blue-700 bg-clip-text text-transparent mb-2 leading-tight uppercase ${department.id === "ai"
                      ...
                      <div className="space-y-8">
                        <div className="relative inline-block">
                          <motion.h2
                            initial={{ opacity: 0, y: -10 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="text-3xl md:text-5xl font-black text-indigo-700 mb-2 leading-tight"
                          >
                            {currentData?.title}
                          </motion.h2>
                          <motion.div
                            ...
                            <div className="mt-4">
                              ...
                              <ul className="space-y-3 list-none">
                                {currentData?.highlights?.map((item, i) => (
                                  ...
                                  >
                                    <span className="w-6 h-6 rounded-full bg-indigo-600 text-white flex items-center justify-center text-sm mt-1">
                                      {i + 1}
                                    </span>
            ...
            >
              {[
                ...
                <div key={item.key} className="mb-2">
                  ...
                  >
                    <div className="p-4 bg-white rounded-xl border border-gray-100 text-sm text-gray-600 leading-relaxed whitespace-pre-wrap">
