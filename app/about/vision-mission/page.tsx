  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-slate-50 font-sans">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #f0f4ff 0%, #fdf8f0 40%, #eef2ff 100%)",
        }}
      >
        {/* Animated glowing orbs in background */}
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="orb-float absolute w-[500px] h-[500px] rounded-full opacity-30 top-[-100px] left-[-100px]"
            style={{
              background:
                "radial-gradient(circle, #b8d0ff 0%, transparent 70%)",
              animationDuration: "12s",
            }}
          />
          <div
            className="orb-float absolute w-[400px] h-[400px] rounded-full opacity-25 bottom-[-80px] right-[-80px]"
            style={{
              background:
                "radial-gradient(circle, #f4c26080 0%, transparent 70%)",
              animationDuration: "16s",
              animationDelay: "4s",
            }}
          />
          <div
            className="orb-float absolute w-[300px] h-[300px] rounded-full opacity-20 top-[40%] left-[50%]"
            style={{
              background:
                "radial-gradient(circle, #a5c8ff 0%, transparent 70%)",
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-stretch min-h-[600px]">
            ...
            >
              ...
              <blockquote className="text-lg text-slate-700 group-hover:text-amber-100 leading-relaxed italic border-l-4 border-amber-500 group-hover:border-amber-400 pl-6 mb-8 transition-all duration-500">
                &quot;Transformative education by pursuing excellence in
                Engineering and Management through enhancing skills to meet the
              ...
              <p className="text-slate-600 group-hover:text-blue-200 text-base leading-relaxed transition-colors duration-500">
                Our vision defines our long-term aspirations. At AIET, we aim to
                deliver transformative education that is adaptive, inclusive,
                and future-ready. We believe in not just preparing students for
                today&apos;s challenges but empowering them to shape tomorrow.
              </p>
            </section>
            ...
            >
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-start gap-4 text-slate-700 group-hover:text-amber-100 transition-colors duration-500"
                  >
              ...
              <p className="text-slate-500 group-hover:text-blue-200 text-base leading-relaxed italic border-t border-amber-200 group-hover:border-white/20 pt-6 transition-all duration-500">
                Our mission clearly outlines the path to achieve our vision.
                Through quality-driven technical education and ethical
                development, we build not only professionals but also
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #fdf8f0 0%, #f0f4ff 50%, #fdf8f0 100%)",
        }}
      >
        {/* Background orbs */}
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="orb-float absolute w-[400px] h-[400px] rounded-full opacity-20 top-[-80px] right-[-80px]"
            style={{
              background:
                "radial-gradient(circle, #b8d0ff 0%, transparent 70%)",
          ...
          />
          <div
            className="orb-float absolute w-[350px] h-[350px] rounded-full opacity-15 bottom-[-60px] left-[-60px]"
            style={{
              background:
                "radial-gradient(circle, #f4c26080 0%, transparent 70%)",
        ...
        <div className="relative z-10 px-6 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 text-base max-w-2xl mx-auto leading-relaxed">
              Graduates of our engineering programs will demonstrate the
              following program outcomes upon completion of their degree.
            </p>
          </div>
