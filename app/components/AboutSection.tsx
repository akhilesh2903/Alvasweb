...
export default function AboutSection() {
  ...
  return (
    <section
      id="about-section"
      className="relative py-20 bg-gradient-to-b from-slate-50 to-slate-100 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 items-center relative z-20">
        <div>
          ...
          <p className="reveal-item opacity-0 translate-y-8 text-slate-600 text-sm md:text-base leading-relaxed mb-8 font-medium text-justify border-l-4 border-yellow-400 pl-5">
            Welcome to{" "}
            <strong>Alva&apos;s Institute of Engineering & Technology</strong>.
            Nestled in the greens of Moodbidri, we ignite innovation with a 24/7
            research ecosystem.
          </p>
        ...
        <div className="about-image-wrapper perspective-container relative z-20">
          ...
          >
            <div
              ...
              style={{ backgroundImage: `url('${virtualTourImage}')` }}
            ></div>
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 transform translate-z-10">
              <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <h4 className="text-white text-2xl font-bold font-serif leading-tight mb-1">
                  Experience Campus
                </h4>
